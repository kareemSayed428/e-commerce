...
function Contact() {
    ...
    const showTyping = function() {
        if(nameInput.current.value.length > 0 || emailInput.current.value.length > 0 || textareaInput.current.value.length > 0) {
            setTyping(true);
        } else {
            setTyping(false);
        }
    ...
    const variants = {
        ...
        animate: {
            ...
            transition: {
                duration: 0.5,
                staggerChildren: 0.1, // stage to make children in div abeare one another one - like delay
            },
        },
    }
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_mu2xznr', 'template_0y0uvlk', formRef.current, {
            publicKey: 'TFwEAmFkrlRYM-pZX',
          })
          .then(
            () => { // in case of all seccess
                setSeccess(true);
    ...
    return(
        ...
        <div className='contact'>
            <div className='container'>
                ...
                className='work-to-gether'>
                    <motion.h1 variants={variants}>Let's work together</motion.h1>
                    <motion.div variants={variants} className='info'>
                        <h3>Mail</h3>
                        <p>Kareemsayed428@gmail.com</p>
                    </motion.div>
                    <motion.div variants={variants} className='info'>
                        <h3>Address</h3>
                        <p>Egypt - Cairo</p>
                ...
                className='contact-svg'>
                    ...
                    <form ref={formRef} onSubmit={sendEmail}>
                        ...
                        {seccess && <p className='seccess'>Email sent successfully <i className="fa-solid fa-envelope-circle-check"></i></p>}
